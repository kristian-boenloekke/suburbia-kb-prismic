...
export function Skateboard({
    ...
    // Wheel Textures
    const wheelTextures = useTexture(wheelTextureURLs) //now we have an array of textures
    wheelTextures.forEach((texture) => {
        texture.flipY = false
        texture.colorSpace = THREE.SRGBColorSpace // comment out, colors are much more muted
    })
    ...
    const deckTextures = useTexture(deckTextureURLs) //now we have an array of textures
    ...
    metalNormal.wrapS = THREE.RepeatWrapping //RepeatWrapping = 1000
