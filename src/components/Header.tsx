...
export async function Header() {
    ...
    return (
        ...
        z-50 ~h-32/48 ~p-4/6 md:h-32'>
            <div className='mx-auto grid w-full max-w-6xl grid-cols-[auto,auto]
            items-center gap-6 md:grid-cols-[1fr,auto,1fr]'>
                <Link href={'/'} className='justify-self-start'>
                    <Logo className='text-brand-purple ~h-12/20' />
                </Link>
                <nav aria-label='main' className='col-span-full row-start-2 
