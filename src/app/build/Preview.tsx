...
export default function Preview({ wheelTextureURLs, deckTextureURLs }: Props) {
    ...
    function setCameraControls(target: THREE.Vector3, pos: THREE.Vector3) {
        ...
        cameraControls.current.setTarget(target.x, target.y, target.z, true) // true sætter transition fra target til target
    ...
    return (
        <Canvas camera={{position: [2.5, 1, 0], fov: 50}} shadows>
            <Suspense fallback={null}>
                ...
                />
                <StageFloor />
                {/* vi kan nu gå igennem gulvet, for at undgå det laver vi en planeGeometry med floorRef og funktion onCameraControlStart som gives til CameraControls onStart */}
