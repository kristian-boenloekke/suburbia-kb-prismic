...
const MASK_CLASSES = `[mask-image:url(/video-mask.png)] [mask-mode:alpha] 
[mask-position:center_center] [mask-repeat:no-repeat] [mask-size:100%_auto]`
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-video">
        {/* Masks */}
        <div
          className={clsx(MASK_CLASSES,
            `bg-brand-lime absolute inset-0 
            ~translate-x-2/3 ~translate-y-2/3`
          )}
        />
